#!/usr/bin/env python3
"""
CIFAR-10 Multifactor ANOVA Experiment (Augmentation Edition)

Design: 3 x 3 x 3 full factorial = 27 treatments x 3 reps = 81 runs
Model:  Simple 3-block CNN (~90K params)

Factor A - Resolution:   32x32 (native), 64x64, 96x96
